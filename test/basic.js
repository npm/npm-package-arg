...
require('tap').test('basic', function (t) {
  ...
  t.has(npa.resolve('foo', 'ipfs://some-cid', '/test/a/b'), {type: 'ipfs'}, 'npa.resolve ipfs protocol')
  t.has(npa.resolve('foo', 'ipns://some-cid', '/test/a/b'), {type: 'ipns'}, 'npa.resolve ipns protocol')
  t.has(npa.resolve('foo', 'ipns://some-cid#1.0.0', '/test/a/b'), {type: 'ipns'}, 'npa.resolve ipns protocol with version')
